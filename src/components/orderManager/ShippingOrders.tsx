// src/components/maketingManager/ShippingOrders.tsx
"use client";
...
const ShippingOrders: React.FC = () => {
  ...
  if (!orders.length) return <div>Không có đơn đang giao.</div>;

  return (
    <div className="p-4">
      <h2 className="text-xl font-semibold mb-4">Đơn hàng đang giao</h2>
      ...
      >
        {updating ? "Đang xử lý…" : `Đã giao hàng (${selectedIds.length})`}
      </button>
