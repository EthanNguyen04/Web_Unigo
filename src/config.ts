...
export const patch_discount = `${BASE_URL}/manager/product_discount/`;

export const Get_product = `${BASE_URL}/api/product/`;
export const Get_evaluate_product = `${BASE_URL}/api/evaluate/product/`;
